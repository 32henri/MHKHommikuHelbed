...
public partial class MainPage : ContentPage
{
    ...
    private async Task kukkumine()
    {
        while (true)
        {
            ...
            var moveDownAnimation2 = new Animation(v => lusikaskukub2.TranslationY = v, -lusikaskukub2.Height, 1200);
            var moveDownAnimation3 = new Animation(v => lusikaskukub3.TranslationY = v, -lusikaskukub3.Height, 1200);
            var moveDownAnimation4 = new Animation(v => lusikaskukub4.TranslationY = v, -lusikaskukub4.Height, 1200);
            var moveDownAnimation5 = new Animation(v => lusikaskukub5.TranslationY = v, -lusikaskukub5.Height, 1200);
            ...
            parentAnimation.Commit(lusikaskukub, "kukkumine", length: 4000, repeat: () => true);
            parentAnimation.Commit(lusikaskukub1, "kukkumine", length: 4100, repeat: () => true);
            parentAnimation.Commit(lusikaskukub2, "kukkumine", length: 4200, repeat: () => true);
            parentAnimation.Commit(lusikaskukub3, "kukkumine", length: 4300, repeat: () => true);
            parentAnimation.Commit(lusikaskukub4, "kukkumine", length: 4400, repeat: () => true);
            parentAnimation.Commit(lusikaskukub5, "kukkumine", length: 4500, repeat: () => true);

            //ules

            var parentAnimation10 = new Animation();
            var moveDownAnimation11 = new Animation(v => lusikaskukub11.TranslationY = v, -lusikaskukub11.Height, -1200);
            var moveDownAnimation22 = new Animation(v => lusikaskukub22.TranslationY = v, -lusikaskukub22.Height, -1200);
            var moveDownAnimation33 = new Animation(v => lusikaskukub33.TranslationY = v, -lusikaskukub33.Height, -1200);
            var moveDownAnimation44 = new Animation(v => lusikaskukub44.TranslationY = v, -lusikaskukub44.Height, -1200);
            var moveDownAnimation55 = new Animation(v => lusikaskukub55.TranslationY = v, -lusikaskukub55.Height, -1200);
            var moveDownAnimation66 = new Animation(v => lusikaskukub66.TranslationY = v, -lusikaskukub66.Height, -1200);
            ...
            parentAnimation10.Commit(lusikaskukub11, "kukkumine", length: 4000, repeat: () => true);
            parentAnimation10.Commit(lusikaskukub22, "kukkumine", length: 4100, repeat: () => true);
            parentAnimation10.Commit(lusikaskukub33, "kukkumine", length: 4200, repeat: () => true);
            parentAnimation10.Commit(lusikaskukub44, "kukkumine", length: 4300, repeat: () => true);
            parentAnimation10.Commit(lusikaskukub55, "kukkumine", length: 4400, repeat: () => true);
            parentAnimation10.Commit(lusikaskukub66, "kukkumine", length: 4500, repeat: () => true);
